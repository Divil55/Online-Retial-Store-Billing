...
public class retail extends JFrame implements ActionListener,ItemListener
{
    HashMap<String, String> product_and_price;
    String a[] = { "Select category", "Dals", "Dairy products", "Snacks","HomeCare","Beverages","Rice and Flours" };
    ...
    public retail()
    {
       ...
       product_and_price.put("Room Freshener","265");
    ...
    public void itemStateChanged(ItemEvent e) {
        ...
        String b[] = { "select Dals","Redgram","Blackgram", "Moong" };
        String c[] = {"select Dairies", "kova", "Paneer", "Curd"};
        String d[] = {"select Snacks", "Lays", "kitkat", "Cake" };
        String v[] = {"select HomeCare","Detergent","Dishwash","Room Freshener","Surface Cleaner"};
        ...
        if (e.getSource() == cat_list) {
                if (cat_list.getSelectedItem().equals("Select category")) {
                        product_list.setEnabled(false);
                } else if (cat_list.getSelectedItem().equals("Dals")) {
